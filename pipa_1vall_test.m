...
tic
model1 = svm_train_1vall(train_label, sparse(feature1(:, train_id_test, 1))', '-B 1 -c 1 -q');
save('model1.mat', 'model1')
[predicted_label1, accuracy1, dv] = svm_predict_1vall(test_label, sparse(feature1(:, test_id_test, 1))', model1, '-q');
fprintf('Head model accuracy: %f\n', accuracy1(1));
toc

tic
model2 = svm_train_1vall(train_label, sparse(feature2(:, train_id_test, 1))', '-B 1 -c 1 -q');
save('model3.mat', 'model3')
[predicted_label2, accuracy2, dv] = svm_predict_1vall(test_label, sparse(feature2(:, test_id_test, 1))', model2, '-q');
fprintf('Head + Full body + Upper body model accuracy: %f\n', accuracy2(1));
toc

tic
model3 = svm_train_1vall(train_label, sparse(feature3(:, train_id_test, 1))', '-B 1 -c 1 -q');
save('model3.mat', 'model3')
[predicted_label13, accuracy3, dv] = svm_predict_1vall(test_label, sparse(feature3(:, test_id_test, 1))', model3, 'q');
